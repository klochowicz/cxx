...
rust::Option<const Shared&> c_return_rust_ref_option_shared(const Shared&);
rust::Option<Shared&> c_return_rust_mut_option_shared(Shared&);
rust::Option<Shared&> c_return_rust_pin_mut_option_shared(Shared&);
rust::Option<const C&> c_return_rust_ref_option_opaque(const C&);
rust::Option<C&> c_return_rust_pin_mut_option_opaque(C&);
rust::Option<const uint8_t&> c_return_rust_ref_option_native(const uint8_t&);
rust::Option<uint8_t&> c_return_rust_mut_option_native(uint8_t&);
rust::Option<uint8_t&> c_return_rust_pin_mut_option_native(uint8_t&);
rust::Option<const rust::Vec<uint8_t>&> c_return_rust_ref_option_vec_native(const rust::Vec<uint8_t>&);
rust::Option<rust::Vec<uint8_t>&> c_return_rust_mut_option_vec_native(rust::Vec<uint8_t>&);
rust::Option<const rust::Vec<Shared>&> c_return_rust_ref_option_vec_shared(const rust::Vec<Shared>&);
rust::Option<rust::Vec<Shared>&> c_return_rust_mut_option_vec_shared(rust::Vec<Shared>&);
rust::Option<const rust::Vec<rust::String>&> c_return_rust_ref_option_vec_string(const rust::Vec<rust::String>&);
...
void c_take_rust_option_box(rust::Option<rust::Box<Shared>>);
void c_take_rust_ref_option_shared(rust::Option<const Shared&>);
void c_take_rust_mut_option_shared(rust::Option<Shared &>);
void c_take_rust_pin_mut_option_shared(rust::Option<Shared &>);
void c_take_rust_ref_option_opaque(rust::Option<const R&>);
void c_take_rust_mut_option_opaque(rust::Option<R &>);
void c_take_rust_pin_mut_option_opaque(rust::Option<R &>);
void c_take_rust_ref_option_native(rust::Option<const uint8_t&>);
void c_take_rust_mut_option_native(rust::Option<uint8_t &>);
void c_take_rust_ref_option_bool(rust::Option<const bool&>);
void c_take_rust_mut_option_bool(rust::Option<bool&>);
void c_take_rust_ref_option_char(rust::Option<const char&>);
void c_take_rust_mut_option_char(rust::Option<char&>);
void c_take_rust_pin_mut_option_native(rust::Option<uint8_t &>);
void c_take_rust_ref_option_vec_native(rust::Option<const rust::Vec<uint8_t>&>);
void c_take_rust_mut_option_vec_native(rust::Option<rust::Vec<uint8_t>&>);
void c_take_rust_ref_option_vec_shared(rust::Option<const rust::Vec<Shared>&>);
void c_take_rust_mut_option_vec_shared(rust::Option<rust::Vec<Shared>&>);
void c_take_rust_ref_option_vec_string(rust::Option<const rust::Vec<rust::String>&>);
